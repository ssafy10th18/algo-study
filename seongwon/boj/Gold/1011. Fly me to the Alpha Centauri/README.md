...
### 풀이
 - 문제의 입력이 0 ~ 2<sup>31</sup> 이기 때문에 일일이 계산할 수 없었습니다.
 - 따라서 문제의 규칙을 찾아야 하는데 하나하나 계산해 본 결과는 아래와 같습니다.
    
    |작동횟수|거리 갯수|거리 범위|최댓값|
    |----|-------|---|---|
    |1|1|1|1|
    |2|1|2|1|
    |3|2|3~4|2|
 ...
 - 거리 갯수와 최댓값이 2번 나타나고 1씩 증가하는데 거리의 범위에서 최댓값의 제곱을 하면 해당 범위의 중간 값을 얻을 수 있습니다.
 - 최댓값 3 = 9 -> 9 - (3 - 1) ~ 9 + 3 -> 7 ~ 12 답은 3
 - 최댓값은 거리의 제곱근의 반올림을 하면 구할수 있습니다.
